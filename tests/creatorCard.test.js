...
describe('CreatorCard API Tests', () => {
    ...
    describe('POST /creator-cards - Create', () => {
        ...
        it('should return SL02 when slug is already taken', async () => {
            creatorCardsDb.push(createCard({
                slug: 'techtalks-podcast',
                title: 'TechTalks Podcast',
                creator_reference: 'crt_3f8k9m2x4p7w6q5z',
            }));
            ...
            creatorCardsDb = [
                createCard({
                    ...
                    service_rates: {
                        currency: 'GBP',
                        rates: [
                            { name: 'Newsletter Ad', description: 'Single newsletter ad placement', amount: 1500 },
                            { name: 'Featured Article', description: 'Featured article with backlink', amount: 3500 }
                        ],
                    },
                }),
                createCard({
